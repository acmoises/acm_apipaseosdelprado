    ...
    <div class="receipt">
        <div class="qr-title-container">
            ...
            <div class="receipt-header">
                ...
                <h3 class="font-semibold">Recibo de Pago</h3>
                <p><strong>Folio: {{ $payment->id }}</strong></p>
                <p><strong>Identificador de pago:</strong> {{ $payment->payment_identifier }}</p>
            </div>
        </div>
        ...
        <table class="table">
            ...
            <tr>
                <th>Monto</th>
                <td>{{ number_format($payment->amount, 2) }} {{ config('app.currency', 'MXN') }}</td>
            </tr>
        </table>
